    ...
    <section className="bg-gradient-to-br from-amber-50 via-white to-amber-50/30">
      <div className="container mx-auto max-w-5xl px-5 md:px-6 py-10 md:py-12">
        <div className="mb-6 md:mb-8 text-center">
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">Today's Gold Price Chart</h1>
          <p className="text-sm md:text-base text-muted-foreground mt-1">Real-time market tracking for informed decisions</p>
        </div>
        ...
        <div className="rounded-2xl shadow-lg overflow-hidden">
          <div className="flex items-center justify-between px-6 md:px-7 py-5 md:py-6 bg-gradient-to-r from-amber-500 to-amber-600 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm md:text-base opacity-90">Current Rate</div>
                <div className="text-2xl md:text-3xl font-bold leading-tight">24K AED {baseGoldPrice.toFixed(2)}</div>
                <div className="text-xs md:text-sm opacity-95">per gram • 0.95% vs Yesterday</div>
              </div>
            </div>
            <div className="flex items-center gap-2 md:gap-3 text-sm md:text-base">
              <span>Karat Type:</span>
              <select
                value={selectedKarat}
          ...
          {/* Karat prices table matching screenshot styling */}
          <div className="px-6 md:px-7 pb-6 md:pb-8">
            <div className="mt-4 md:mt-6 overflow-hidden rounded-xl border border-gray-200 shadow-sm">
              <div className="bg-amber-50 px-4 md:px-5 py-3 md:py-3.5 text-sm md:text-base font-medium text-amber-700 border-b border-gray-200">Today's Gold Prices by Karat</div>
              <div className="flex items-center justify-between px-4 md:px-5 py-3 text-sm md:text-lg text-neutral/70 border-b border-gray-200">
                <span className="font-medium">Karat</span>
                <span className="font-medium">Price per Gram</span>
              </div>
              <div className="divide-y divide-gray-100">
                {karats.map(k => {
                  ...
                  return (
                    ...
                    >
                      <span className="text-neutral font-medium text-sm md:text-base">{k.label.replace(/\s*\(.*\)/,'')}</span>
